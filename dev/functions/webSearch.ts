...
import { SearchQuery } from "./queryProcessing.js";
...
export interface SearchResult {
    ...
    sourceQuery?: string; // Track which query generated this result
}
...
export interface EvidenceItem {
    ...
    relevance: number;
    sourceQuery?: string; // Track which query generated this evidence
}
...
export class WebSearchService {
    ...
    private static readonly QUERY_DELAY = 500; // Delay between queries to avoid rate limiting
    ...
    public static async searchMultipleQueries(queries: SearchQuery[]): Promise<SearchResult[]> {
    ...
    private static removeDuplicateResults(results: SearchResult[]): SearchResult[] {
    ...
    private static calculateRelevance(snippet: string, content: string, sourceQuery?: string): number {
    ...
    public static createEvidenceSummary(evidenceItems: EvidenceItem[]): string {
        ...
        const queryGroups = new Map<string, EvidenceItem[]>();
        const noQueryItems: EvidenceItem[] = [];
