...
export class Zalgo {
    ...
    static fullText(text: string, upCount = 3, midCount = 1, downCount = 2): string {
    ...
    private static randomChars(arr: string[], count: number): string {
        let out = '';
