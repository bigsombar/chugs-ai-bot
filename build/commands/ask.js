...
let AskCommand = class AskCommand {
    static { AskCommand_1 = this; }
    static secretManager = new BWSecretManager();
    async ask(question, interaction) {
        ...
        const apiKey = await AskCommand_1.secretManager.getSecret(process.env.AI_KEY);
        if (!apiKey) {
...
], AskCommand.prototype, "ask", null);
AskCommand = AskCommand_1 = __decorate([
    Discord()
], AskCommand);
export { AskCommand };
